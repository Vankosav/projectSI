...
const Leadership = () => {
  return (
    <div className="bg-black bg-opacity-75 w-full text-white py-16 px-10 md:px-20 rounded-lg shadow-lg pt-10">
      {/* Title and Paragraph */}
      ...
      {/* Leadership Photos */}
      <div className="flex flex-col md:flex-row justify-center items-center gap-8 px-4 md:px-20 py-8">
        {/* Team Member 1 */}
